...
return [
	...
	'activation'	=> [
		'success'		=> '登録完了しました。<br> 本サイトのＩＤは:treasure_id。 <br>バイコーンサイトのログインは:bicorn_id、パスワードは本サイトと同じです。バイコーンのログインパスワードの変更はバイコーンサイトで行ってください。',
		'already_exist'	=> '登録完了しました。<br> 本サイトのＩＤは:treasure_id。 <br>バイコーンサイトは以前と同様のＩＤ（:bicorn_id）及びパスワードでログイン出来ます。',
