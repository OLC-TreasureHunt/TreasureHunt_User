...
return [
    ...
    'forgot'	=> [
        'txt1'		=> '이 메일은【%s】에서 자동송신되였습니다.',
        'txt2'		=> '아래의 링크를 눌러 암호를 재설정할수 있습니다.', 
    ],

	'register'	=> [
		'txt1'		=> '%s 님ㄴ',
		'txt2'		=> '%s 에 가입하신것을 환영합니다.',
		'txt3'		=> '아래의 링크를 눌러 등록을 완료하세요.',

		'txt4'		=> '■URL',

		'txt5'		=> '■새 회원등록을 원하지 않는 경우',
		'txt6'		=> '새 회원 등록을 계속하고 싶지 않거나 당사에 회원을 등록하지 않은 경우 이 이메일을 무시하십시오.',
	],
