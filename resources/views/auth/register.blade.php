                        ...
                        <form method="post" id="register_form" class="form-validate mt-5" action="{{ route('register') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control    @error('postal_code') is-invalid @enderror" name="postal_code" placeholder="{{ trans('register.postal_code_placeholder') }}" value="{{ old('postal_code') }}">
                                    @error('postal_code')
                                        <div class="is-invalid">{{ $message }}</div>
                                    @enderror
                                </div>
