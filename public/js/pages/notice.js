...
var download = new Vue({
  ...
  methods: {
    loadNotices: function loadNotices(page) {
      var _this = this;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                axios__WEBPACK_IMPORTED_MODULE_2___default().get(window.Laravel.baseUrl + '/notice/list?page=' + page).then(function (response) {
    ...
    notice_link: function notice_link(id) {
      return window.Laravel.baseUrl + '/news/' + id;
    },
    noticeClickHandler: function noticeClickHandler(notice) {
      axios__WEBPACK_IMPORTED_MODULE_2___default().get(window.Laravel.baseUrl + '/notice/read/' + notice.id);
      this.callSweetAlert(notice.notice.title, notice.notice.content, "", this.trans.button.confirm);
      this.notices.data.forEach(function (value) {
