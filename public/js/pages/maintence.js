...
"use strict";
/*!*****************************************!*\
  !*** ./resources/js/pages/maintence.js ***!
  \*****************************************/
...
var base = new Vue({
  ...
  methods: {
    nockServer: function nockServer() {
      var self = this;
      axios__WEBPACK_IMPORTED_MODULE_0___default().get(window.Laravel.baseUrl + '/nock').then(function (response) {
